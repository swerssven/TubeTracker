...
export class PostComponent {
  ...
  share(){
    ...
    content = content.replaceAll('{{userImage}}', this.post.userImage ? this.post.userImage : defAvatar);
    content = content.replaceAll('{{creatorNickname}}', this.post.userNickname!);
