...
export class MovieReviewComponent {
  ...
  ngOnInit(): void {
    ...
    this.review.movieReviewId = this.review.serieReviewId;
  }
  ...
  share() {
    ...
    content = content.replaceAll(
      '{{userImage}}',
      this.review.userImage ? this.review.userImage : defAvatar
    );
  ...
  deleteReview() {
    if (this.contentType == 'movie') {
      this.subscriptions.add(
        this.movieService.deleteMovieReview(this.review.movieReviewId!).subscribe()
      );
    } else if (this.contentType == 'serie') {
      this.subscriptions.add(
        this.serieService.deleteSerieReview(this.review.movieReviewId!).subscribe()
      );
    }
    this.reloadReviews.emit(this.review);
  }
}
